...
\begin{figure*}[th!]
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[width=0.9\columnwidth]{figs/cl_irt_mnist}
		\caption{\label{fig:cl_mnist}} 
		\vspace{-2em} 
	\end{subfigure} 
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[width=0.9\columnwidth]{figs/cl_irt_cifar}
...
\begin{figure*}[th!]
	...
	\begin{subfigure}[b]{0.45\textwidth}
		\centering
		\includegraphics[width=0.9\columnwidth]{figs/cl_irt_sstb}
