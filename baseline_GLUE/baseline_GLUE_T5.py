...
for task in GLUE_TASKS:
    ...
    for model_checkpoint in models:
        ...
        optimizer = AdamW(model.parameters(), lr=1e-4, weight_decay=0.01, eps=1e-6, betas=(0.9, 0.999))
        ...
        best_accuracy = 0.0
        early_stop_count = 0
        patience = 3  # Stop if performance doesn't improve for 2 consecutive epochs
