...
def get_epoch_training_data(ts, args, epoch, task, theta_hat=None, diffs_sorted_idx=None, lower_offset=np.NINF, upper_offset=0):
    ...
    if args.use_word_rarity:
        assert ts.tensors[3] is not None  # Ensure 'example_rarity' is included
    ...
    # Extract tensors
    input_ids, attention_mask, labels, difficulties = training_set.tensors
    ...
    if args.use_word_rarity:
        difficulties = training_set.tensors[3]  # Assuming 'example_rarity' is the 4th tensor
