...
python -u -m models.sstb --dynet-autobatch 1 --dynet-gpus 1 --dynet-mem 10000 --gpu 0 --data-dir $DATADIR --strategy theta --num-epochs $NUMEPOCHS --diff-dir $DIFFDIR --task $TASK 
