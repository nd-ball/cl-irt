...
do 
    ...
    do 
        ...
        do 
            sbatch -p titanx-long --gres=gpu:1 --mem=90gb --output=logs/bert/bert-$m-$strat-$o-length.log --wrap="python -u -m models.$m_bert --gpu 0 --data-dir /mnt/nfs/work1/hongyu/lalor/data/cl-data/ --strategy $strat --use-length --ordering $o --num-epochs $NUMEPOCHS --cache-dir /mnt/nfs/work1/hongyu/lalor/data/bert/"
            sbatch -p titanx-long --gres=gpu:1 --mem=90gb --output=logs/bert/bert-$m-$strat-$o-irt.log --wrap="python -u -m models.$m_bert --gpu 0 --data-dir /mnt/nfs/work1/hongyu/lalor/data/cl-data/ --strategy $strat --ordering $o --num-epochs $NUMEPOCHS --cache-dir /mnt/nfs/work1/hongyu/lalor/data/bert/" 
        done 
    done
done
