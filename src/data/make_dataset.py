...
def main(): 
    ...
    data_path = '/mnt/nfs/work1/hongyu/lalor/data/cl-data/raw/'
    ...
    dev = pd.read_csv(data_path + devfile, sep='\t',
                      usecols=['gold_label', 'sentence1', 'sentence2', 'pairID'])
    test = pd.read_csv(data_path + testfile_snli, sep='\t',
                            usecols=['gold_label', 'sentence1', 'sentence2', 'pairID'])
    train_difficulties = pd.read_csv(data_path + 'snli_train_diffs.csv', sep=',',
