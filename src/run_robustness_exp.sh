...
do 
    ...
    do
        ...
        do 
            # CL, balanced
            sbatch -p titanx-long --gres=gpu:1 --mem=90gb --output=logs/robustness/sstb_cl_balanced-$s-$o-$k.log --wrap="python -u -m models.sstb --dynet-autobatch 1 --dynet-gpu 1 --dynet-mem 11000 --gpu 0 --data-dir /mnt/nfs/work1/hongyu/lalor/data/cl-data/ --strategy $s --balanced --ordering $o --num-epochs $NUMEPOCHS"

            # CL, not balanced
            sbatch -p titanx-long --gres=gpu:1 --mem=90gb --output=logs/robustness/sstb_cl_not_balanced-$s-$o-$k.log --wrap="python -u -m models.sstb --dynet-autobatch 1 --dynet-gpu 1 --dynet-mem 11000 --gpu 0 --data-dir /mnt/nfs/work1/hongyu/lalor/data/cl-data/ --strategy $s --ordering $o --num-epochs $NUMEPOCHS"
        done 
    done 
    ...
    # random ordered (fixed order across all epochs) 
    # balanced
    sbatch -p titanx-long --gres=gpu:1 --mem=90gb --output=logs/robustness/sstb_cl_ordered_balanced_hardest_random-$k.log --wrap="python -u -m models.sstb --dynet-autobatch 1 --dynet-gpu 1 --dynet-mem 11000 --gpu 0 --data-dir /mnt/nfs/work1/hongyu/lalor/data/cl-data/ --strategy ordered --balanced --ordering hardest --random --num-epochs $NUMEPOCHS"

    # not balanced
    sbatch -p titanx-long --gres=gpu:1 --mem=90gb --output=logs/robustness/sstb_cl_ordered_not_balanced_hardest_random-$k.log --wrap="python -u -m models.sstb --dynet-autobatch 1 --dynet-gpu 1 --dynet-mem 11000 --gpu 0 --data-dir /mnt/nfs/work1/hongyu/lalor/data/cl-data/ --strategy ordered --ordering hardest --random --num-epochs $NUMEPOCHS"


    # random simple 
    # balanced
    sbatch -p titanx-long --gres=gpu:1 --mem=90gb --output=logs/robustness/sstb__cl_simple_balanced_random-$k.log --wrap="python -u -m models.sstb --dynet-autobatch 1 --dynet-gpu 1 --dynet-mem 11000 --gpu 0 --data-dir /mnt/nfs/work1/hongyu/lalor/data/cl-data/ --strategy simple --balanced --ordering hardest --random --num-epochs $NUMEPOCHS"

    # not balanced
    sbatch -p titanx-long --gres=gpu:1 --mem=90gb --output=logs/robustness/sstb_cl_simple_not_balanced_random-$k.log --wrap="python -u -m models.sstb --dynet-autobatch 1 --dynet-gpu 1 --dynet-mem 11000 --gpu 0 --data-dir /mnt/nfs/work1/hongyu/lalor/data/cl-data/ --strategy simple --ordering hardest --random --num-epochs $NUMEPOCHS" 
